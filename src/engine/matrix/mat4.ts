 ...
 * @returns {mat4}
 */
export function translate(out: mat, a: mat, v: vec): mat{
 ...
 * @returns {mat4} out
 */
export function transpose(out: mat, a: mat): mat {
 ...
 * @returns {mat4} out
 */
export function invert(out: mat, a: mat): mat {
    let a00 = a[0], a01 = a[1], a02 = a[2], a03 = a[3];
    let a10 = a[4], a11 = a[5], a12 = a[6], a13 = a[7];
    let a20 = a[8], a21 = a[9], a22 = a[10], a23 = a[11];
    let a30 = a[12], a31 = a[13], a32 = a[14], a33 = a[15];
 ...
 * @returns {mat4} out
 **/
export function scale(out:mat, a:mat, v:vec) {
    let x = v[0], y = v[1], z = v[2];
 ...
 * @returns {mat4} out
 */
export function rotate(out:mat, a:mat, rad:number, axis:vec) {
 ...
 * @returns {mat4} out
 */
export function rotateX(out:mat, a:mat, rad:number) {
    let s = Math.sin(rad);
    let c = Math.cos(rad);
    let a10 = a[4];
    let a11 = a[5];
 ...
 * @returns {mat4} out
 */
export function rotateY(out:mat, a:mat, rad:number) {
    let s = Math.sin(rad);
    let c = Math.cos(rad);
    let a00 = a[0];
    let a01 = a[1];
 ...
 * @returns {mat4} out
 */
export function rotateZ(out:mat, a:mat, rad:number) {
    let s = Math.sin(rad);
    let c = Math.cos(rad);
    let a00 = a[0];
    let a01 = a[1];
